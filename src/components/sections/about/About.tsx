export default function About() {
  return (
    <section className="py-24 border-t border-[rgba(60,63,65,0.5)]" id="about">
      <div className="font-mono text-[12px] tracking-[.14em] uppercase text-muted mb-4 text-halo">// about</div>
      <div className="grid grid-cols-[1fr_1fr] gap-12 items-start max-[720px]:grid-cols-1">
        <div className="font-mono text-[12px] tracking-[.14em] uppercase text-muted text-halo">// the layer underneath</div>
        <p className="font-display text-[clamp(19px,2.4vw,25px)] leading-[1.5] text-prose max-w-[32ch] text-halo">
          I work on the layer underneath the product — the <b>language</b>, the{' '}
