  ...
  return (
    <footer className="py-10 border-t border-[rgba(60,63,65,0.5)] flex flex-row items-center justify-between flex-wrap gap-4">
      ...
      <span className="flex gap-5">
        <a href="https://github.com/Lumi-Cloud-LLC" target="_blank" rel="noopener" className="font-mono text-[13px] text-muted no-underline hover:text-prose transition-colors duration-150">
          GitHub
        </a>
      </span>
      <small className="font-mono text-[11px] text-muted">
        &copy; 2026 Lumi Cloud LLC
      </small>
    </footer>
  )
}
