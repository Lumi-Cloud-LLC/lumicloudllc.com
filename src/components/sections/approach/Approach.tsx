...
export default function Approach() {
  return (
    <section className="py-24 border-t border-[rgba(60,63,65,0.5)]" id="approach">
      <div className="font-mono text-[12px] tracking-[.14em] uppercase text-muted mb-4 text-halo">// what I do</div>
