export default function Hero() {
  return (
    <header className="min-h-screen flex flex-col justify-center items-center text-center gap-[22px]" id="top">
      <span className="hero-eyebrow font-mono text-[13px] tracking-[.16em] uppercase text-sage-br text-halo transition-[opacity,transform] duration-700 ease-[ease]">
      ...
      <span className="hero-meta font-mono text-[12px] tracking-[.04em] text-muted flex items-center gap-[10px] text-halo transition-[opacity,transform] duration-700 ease-[ease] [transition-delay:400ms]">
